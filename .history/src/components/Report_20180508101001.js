...
import {  Panel,Form,Col,FormGroup,FormControl,ControlLabel } from 'react-bootstrap';
			...
			<Form onSubmit={this.handleSubmit}>
				<FormGroup controlId="formItem">
					 <ControlLabel>Item</ControlLabel>
						<FormControl type="text" placeholder="Item" value={this.props.login.state.user} onChange={this.props.handleChange}/>
				</FormGroup>
			</Form>
		)
	}
